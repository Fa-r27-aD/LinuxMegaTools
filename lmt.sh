...
# Main menu
main_menu() {
    options=("Install Packages" "Remove and Regenerate Machine IDs" "Remove SSH Host Keys and Reconfigure OpenSSH" "Change Hostname and Optionally Update /etc/hosts with a New IP Address" "Add User to Sudo Group" "Disable Root Account" "Enable Root Account and Set Password" "Add a New User" "Delete a User" "Reboot System" "Mount NAS Share" "Set Up LUKS Encryption on a Block Device" "Perform All Actions" "Quit")
    echo -e "\n=== Main Menu ==="
